...
RUN_NAME=person_roi_phone_yolo11s_640_network_phone0_plus_person_20260703
...
if [ -f "$RUN_DIR/weights/best.pt" ]; then
  cp -f "$RUN_DIR/weights/best.pt" "$MODELS_DIR/PERSON_ROI_PHONE_yolo11s_640_network_phone0_plus_person_20260703_best.pt"
  cp -f "$RUN_DIR/weights/last.pt" "$MODELS_DIR/PERSON_ROI_PHONE_yolo11s_640_network_phone0_plus_person_20260703_last.pt"
  echo "copied_best $MODELS_DIR/PERSON_ROI_PHONE_yolo11s_640_network_phone0_plus_person_20260703_best.pt" >> "$WATCH_LOG"
  echo "copied_last $MODELS_DIR/PERSON_ROI_PHONE_yolo11s_640_network_phone0_plus_person_20260703_last.pt" >> "$WATCH_LOG"
else
